...
# License: GNU GPLv3
# Modified by Jens Tinggaard

### OPTIONS AND VARIABLES ###

# dotfilesrepo="https://github.com/lukesmithxyz/voidrice.git"
progsfile="https://raw.githubusercontent.com/Tinggaard/arch/master/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
    ...
    --msgbox "This is the automated arch install :)" 10 60

	whiptail --title "Important Note!" --yes-button "Run it!" \
		--no-button "I'm not ready" \
...
installffaddons(){
	addonlist="ublock-origin decentraleyes multi-account-containers contain-facebook tree-style-tab bitwarden-password-manager wappalyzer"
	addontmp="$(mktemp -d)"
